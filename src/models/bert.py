...
class CategoriesClassifierBERT:
    ...
    def __init__(self):
        ...
        self._model = BertModel.from_pretrained('bert-base-uncased', num_labels=self._categories)
    ...
    def word_categorizer(self, words) -> dict:
        ...
        def get_embeddings(words):
            inputs = self._tokenizer(words, return_tensors='pt', padding=True, truncation=True).to(self._device)
            with torch.no_grad():
